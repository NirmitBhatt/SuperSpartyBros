...
public class CharacterController2D : MonoBehaviour {
    ...
    void Start()
    {
        shake2 = GameObject.FindGameObjectWithTag("ScreenShake2").GetComponent<CameraShake2>();
    }
    void Awake () {
	...
	void Update()
	{
		...
		{
            DoJump();
		}else if(canDoubleJump && Input.GetButtonDown("Jump")) //if candoublejump and jump button pressed, then allow player to double jump 
        {
            DoJump();
    ...
    //make player jump when stun an enemy
